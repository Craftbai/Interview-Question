...
| 控制与信号处理 | 16 | 工程工具与协作 | 16 |
| 操作系统原理 | 20 | 调试与问题定位 | 21 |
| RTOS / FreeRTOS | 25 | 信息安全 | 21 |
| 嵌入式 Linux 应用 | 24 | **汽车电子专题** | **55** |
| Linux 驱动与内核 | 21 | 项目与行为面 | 24 |
| MCU 与硬件 | 24 | | |

其中 **110 题标记为「简历高危」**——这些是因为你简历上写了具体技术名词（AURIX、ECDSA、差分包、Bootloader、UDS、ISO-TP、链接脚本、Qt、ALSA、Modbus、CMake）才会被追问的题，答不上来最伤。可以在筛选面板里单独刷这一组。
